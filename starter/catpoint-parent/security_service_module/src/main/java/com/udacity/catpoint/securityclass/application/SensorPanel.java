package com.udacity.catpoint.securityclass.application;

import com.udacity.catpoint.securityclass.data.AlarmStatus;
import com.udacity.catpoint.securityclass.data.Sensor;
import com.udacity.catpoint.securityclass.data.SensorType;
import com.udacity.catpoint.securityclass.service.SecurityService;
import com.udacity.catpoint.securityclass.service.StyleService;
...
public class SensorPanel extends JPanel implements StatusListener{
    ...
    @Override
    public void sensorStatusChanged() {         //requirement 10
        updateSensorList(sensorListPanel);
    }
}
